"""Regression checks for the ion-parse-sql-flow casebook."""
...
from casebook.harness import assert_expected, ion_parse_sql_flow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ion_parse_sql_flow_summary(), assert_expected())
